--[[
    ...
    ║   • Accent preset management (14 accents)                            ║
    ║   • Neon Glow Engine — dynamic UIStroke & shadow recoloring          ║
    ║   • Runtime theme switching without re-rendering                     ║
    ║   • Transition properties (durations, easing, corner radii)          ║
    ║   • Color math utilities (HSV, Hex, interpolation, luminance)        ║
...
--- @param hex string — Hex color string (e.g., "#FF00AA" or "FF00AA")
--- @return Color3
...
--- @param c Color3 — Input color
--- @return string — "#RRGGBB" formatted hex string
...
--- @param c Color3 — Input color
--- @return number — Perceived luminance (0–1)
...
--- @param c Color3 — Input color
--- @return boolean — True if the color is perceptually dark
...
--- @param c Color3 — Input color
--- @param amount number — Darkening factor (0–1), default 0.2
--- @return Color3
...
--- @param c Color3 — Input color
--- @param amount number — Lightening factor (0–1), default 0.2
--- @return Color3
...
--- @param c Color3 — Input color
--- @param amount number — Saturation adjustment (0–1), default 0.15
--- @return Color3
...
--- @param c Color3 — Input color
--- @param amount number — Desaturation amount (0–1), default 0.15
--- @return Color3
...
--- @function GlowColor
--- @param baseColor Color3 — The base accent color
--- @param intensity number — Glow intensity (0–1), default 0.3
--- @return Color3
...
-- ====================================================================
--  THEME PALETTES — 13 Complete Themes
...
--- @param frame Instance — The GuiObject to apply the gradient to
--- @description Applies the standard BorcaHub logo gradient (blue→purple)
---   at a 135° angle to the specified frame.
---
...
--- @param colorA Color3 — New primary gradient color
--- @param colorB Color3 — New secondary gradient color
...
--- @param parent Instance — Parent frame for the separator
--- @param theme table — Current theme palette
--- @return Instance — The separator Frame with animated gradient
---
...
function ThemeEngine.CreateNeonSeparator(parent, theme)
    ...
    -- FIX: Ganti RenderStepped:Wait() → task.wait()
